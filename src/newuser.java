...
public class newuser extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Bangladesh Power Develpoment Bill");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
            ...
            String efname = jTextField2.getText();
            String ecid = jTextField3.getText();
            String emeternumber = jTextField4.getText();
            String enid = jTextField5.getText();
            String econtactnumber = jTextField6.getText();
            String eaddress = jTextField7.getText();
            String emetertype = jTextField8.getText();
            String emetercost = jTextField9.getText();
        ...
        try{
            ...
            String k = "INSERT INTO new_user VALUES(?,?,?,?,?,?,?,?,?)";
            PreparedStatement ps = con.prepareStatement(k);
            
            ps.setString(1, ename);
            ps.setString(2, efname);
            ps.setString(3, ecid);
            ps.setString(4, emeternumber);
            ps.setString(5, enid);
            ps.setString(6, econtactnumber);
            ps.setString(7, eaddress);
            ps.setString(8, emetertype);
            ps.setString(9, emetercost);
            ...
            setVisible(false);
            new initialcheckout(ecid).setVisible(true);
